...
Use the real shape exposed by [Build weather-inclusive end-to-end prototype](17-build-weather-inclusive-end-to-end-prototype.md), especially `src/basement_analysis/static_site.py`, `src/basement_analysis/cli.py`, `README.md`, and the generated local output at `build/basement-site/index.html` after running `uv run basement`. Also use the report structure from [Physics And Metrology Report Mock](../../../prototypes/physics-and-metrology-report-mock/README.md).
...
Prototype asset: [Static Generator Dashboard/Report Boundary](../../../prototypes/static-generator-dashboard-report-boundary/README.md)
