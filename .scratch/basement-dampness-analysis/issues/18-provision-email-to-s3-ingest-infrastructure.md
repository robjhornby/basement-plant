...
This is later-phase remote ingestion work. Do not start it until the local CSV-to-static-site pipeline is useful and the raw email processing-state prototype exists.
